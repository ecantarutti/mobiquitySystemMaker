...
public class AddingNewEntryWithoutLogin extends JUnitStories {
	 
		public AddingNewEntryWithoutLogin() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/AddingNewEntryWithoutLogin.story");
		}
