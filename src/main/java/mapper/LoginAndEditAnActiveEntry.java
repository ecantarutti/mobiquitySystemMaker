...
public class LoginAndEditAnActiveEntry extends JUnitStories {
	 
		public LoginAndEditAnActiveEntry() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/LoginAndEditAnActiveEntry.story");
		}
