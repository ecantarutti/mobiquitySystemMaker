...
public class LoginAndDeleteAnActiveEntry extends JUnitStories {
	 
		public LoginAndDeleteAnActiveEntry() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/LoginAndDeleteAnActiveEntry.story");
		}
