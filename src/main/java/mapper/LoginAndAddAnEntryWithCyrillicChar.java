...
public class LoginAndAddAnEntryWithCyrillicChar extends JUnitStories {
	 
		public LoginAndAddAnEntryWithCyrillicChar() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/LoginAndAddAnEntryWithCyrillicChar.story");
		}
